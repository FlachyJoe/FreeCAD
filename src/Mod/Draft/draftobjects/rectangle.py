...
class Rectangle(DraftObject):
    ...
    def __init__(self, obj):
        ...
        obj.addLockedProperty("App::PropertyDistance", "Length", "Draft", _tip)

        _tip = QT_TRANSLATE_NOOP("App::Property", "Height of the rectangle")
        obj.addLockedProperty("App::PropertyDistance", "Height", "Draft", _tip)
        ...
        obj.addLockedProperty("App::PropertyInteger", "Rows", "Draft", _tip)

        _tip = QT_TRANSLATE_NOOP("App::Property", "Vertical subdivisions of this rectangle")
        obj.addLockedProperty("App::PropertyInteger", "Columns", "Draft", _tip)
