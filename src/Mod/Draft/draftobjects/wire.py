...
class Wire(DraftObject):
    ...
    def __init__(self, obj):
        ...
        obj.addLockedProperty("App::PropertyLink","Base", "Draft",_tip)

        _tip = QT_TRANSLATE_NOOP("App::Property",
                "The tool object is the wire, it's formed from 2 objects")
        obj.addLockedProperty("App::PropertyLink","Tool", "Draft",_tip)

        _tip = QT_TRANSLATE_NOOP("App::Property",
                "The start point of this line")
        obj.addLockedProperty("App::PropertyVectorDistance","Start", "Draft",_tip)

        _tip = QT_TRANSLATE_NOOP("App::Property",
                "The end point of this line")
        obj.addLockedProperty("App::PropertyVectorDistance","End", "Draft",_tip)
        ...
        obj.addLockedProperty("App::PropertyInteger","Subdivisions", "Draft",_tip)
